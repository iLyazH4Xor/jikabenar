...
document.getElementById("bq").onclick = function() {
  ...
  var { value: jawaban } = await swals.fire({
    ...
    title: 'Isi Pesan Buat Ilyas 👉👈', input: 'text', allowOutsideClick: false, showCancelButton: false,
  ...
  if(jawaban && jawaban.length < 19){
    ...
    window.location = "https://api.whatsapp.com/send?phone=+6281212804012&text=" + pesanwhatsapp;
